...
const projects = [
  ...
  },
  {
    ...
    text: 'OpenWeather APIと連携し、都市検索・現在地取得・日付選択に対応した天気予報Webアプリです。現在の気温、体感温度、湿度、風速、降水情報、日別予報を確認でき、世界各都市の検索にも対応しています。',
    ...
    url: 'https://weather-calendar-app-brown.vercel.app',
    buttonLabel: 'Open Site',
  ...
  },
  {
    ...
    text: '複数のURLからQRコードを一括生成し、PNG・ZIP形式でまとめてダウンロードできるWebツールです。履歴保存や並び替え機能にも対応し、イベント・店舗・SNS運用など幅広い用途で活用できます。',
    ...
    height: 1527,
    imagePosition: 'center top',
    url: 'https://aicmode.github.io/qr-code-bulk-generator/',
    buttonLabel: 'Open Site',
