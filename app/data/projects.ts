...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    category: 'Lightweight Electronic Medical Record Demo',
    summary:
      '看護師経験を活かして設計した、患者情報・疾患・バイタル・看護記録を管理できる簡易電子カルテWebアプリ。',
    problem: '患者情報、疾患、バイタル、看護記録が別々に管理されると、情報確認や入力の流れが分かりにくくなる。',
    solution:
      '患者単位で基本情報、疾患、バイタル、看護記録を一画面に整理し、医療現場の情報構造をイメージした簡易電子カルテWebアプリとして設計。',
    features: [
      '患者登録',
      '患者ID・氏名検索',
      '患者情報編集',
    ...
    projectType: 'Personal Project',
    status: 'released',
    stack: ['React', 'TypeScript', 'Vite', 'CSS', 'Local Storage'],
    tags: ['React', 'TypeScript', 'Healthcare', 'Local Storage'],
    colorLabel: 'React / TypeScript / Vite / Healthcare Workflow',
    accent: '#d4af37',
    tint: '#171208',
    image: '/works/images/medichart-lite.webp',
    imageAlt: 'MediChart LiteのDashboard画面。架空患者の件数、記録、疾患、最近更新した患者を表示',
    imagePosition: 'center top',
